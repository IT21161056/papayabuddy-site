...
const Technologies: React.FC = () => {
  return (
    <section
      id="technologies"
      className="py-20 bg-gradient-to-br from-green-50 to-green-100 overflow-hidden"
    >
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Our tech stack combines cutting-edge machine learning frameworks
            with robust development tools to deliver a powerful and scalable
            solution.
          </p>
        </div>
